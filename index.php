                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-10 col-lg-10">
                            <div class="main-menu d-none d-lg-block">
                                ...
                                <!-- <nav>
                                    <ul class="mein_menu_list" id="navigation">
                                    <li><a ><i class="ti-angle-down"></i></a></li>
                                    <li><a href="./Guest/login.php">Login</a></li>
                                            <li><a href=""></a></li>
...
<script>
    function checkLogin(packageId) {
        // Check if the user is logged in
        <?php if (isset($_SESSION['uid'])) { ?>
            // User is logged in, redirect to the booking page
            window.location.href = "http://localhost/Catering/Project/User/viewpackagebody.php?pid=" + packageId;
        <?php } else { ?>
            // User is not logged in, show an alert
            alert("You need to log in to book this service.");
            // Optionally, you can redirect to the login page
            // window.location.href = "http://localhost/Catering/Project/User/login.php";
        <?php } ?>
    }
</script>
