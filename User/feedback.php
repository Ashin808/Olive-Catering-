...
if(isset($_POST["btn_submit"])) {
    ...
    // $date = $_POST['txt_date'];
    $insQry = "INSERT INTO tbl_feedback(feedback_content, feedback_date, user_id) VALUES ('".$content."', Now(), '".$_SESSION['uid']."')";
    if ($con->query($insQry)) {
        echo "<script>alert('Feedback submitted succesfully..'); window.location.href='Userhomepage.php';</script>";
    } else {
